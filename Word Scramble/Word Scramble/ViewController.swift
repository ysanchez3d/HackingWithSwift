...
class ViewController: UITableViewController {
    ...
    func submit(_ answer: String) {
        ...
        if isPossible(word: lowerAnswer) {
            if isOriginal(word: lowerAnswer) {
                ...
                showErrorMessage(title: "Word used already", errorMessage: "Be more original!")
            }
        } else {
            guard let title = title?.lowercased() else { return }
       
            showErrorMessage(title: "Word not possible", errorMessage: "You can't spell that word from \(title)")
        }
    ...
    func isReal(word: String) -> Bool {
        ...
        if word.utf16.count < 3 || startWord == word {
            return false
        }
